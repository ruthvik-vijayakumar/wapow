  ...
  <div class="profile-container">
    ...
    <div class="profile-info">
      ...
      <div class="profile-details">
        ...
        <p v-if="userProfile.username && userProfile.username !== '@user'" class="user-username">
          ...
          <button class="menu-item" @click="handleNotifications">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                ...
                stroke-linejoin="round"
                stroke-width="2"
                d="M15 17h5l-5 5v-5zM4.83 2.606a1 1 0 01.707-.293L9.414 2H20a1 1 0 011 1v12a1 1 0 01-1 1H5a1 1 0 01-1-1V3a1 1 0 01.83-.394z"
              />
            </svg>
